...
public class UpdateController extends ApiController {
    ...
    public Iterable<Update> gradeHistoryBySubjectAreaAndCourseNumber(
            ...
            @Parameter(name = "page", description = "what page of the data", example = "0", required = true) @RequestParam(defaultValue = "0") int page,
            @Parameter(name = "pageSize", description = "size of each page", example = "5", required = true) @RequestParam(defaultValue = "0") int pageSize) {
