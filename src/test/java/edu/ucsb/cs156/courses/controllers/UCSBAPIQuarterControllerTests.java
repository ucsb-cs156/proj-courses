...
public class UCSBAPIQuarterControllerTests extends ControllerTestCase {
  ...
  public void test_allQuarters() throws Exception {
    ...
    UCSBAPIQuarter M23 = objectMapper.readValue(UCSBAPIQuarter.SAMPLE_QUARTER_JSON_M23,
        UCSBAPIQuarter.class);
    ...
    assertEquals(
        expectedResult,
        objectMapper.readValue(response.getResponse().getContentAsString(), new TypeReference<List<UCSBAPIQuarter>>() {
        }));
