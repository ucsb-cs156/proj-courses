...
public class JobsControllerTests extends ControllerTestCase {
  ...
  ArrayList<Job> emptyArray = new ArrayList<>();
  ...
  private final Page<Job> emptyPage_0_10_DESC_status =
      new PageImpl<>(emptyArray, pageRequest_0_10_DESC_status, 0);
  private final Page<Job> emptyPage_0_10_ASC_createdAt =
      new PageImpl<>(emptyArray, pageRequest_0_10_ASC_createdAt, 0);
  private final Page<Job> emptyPage_0_10_DESC_updatedAt =
      new PageImpl<>(emptyArray, pageRequest_0_10_DESC_updatedAt, 0);
  private final Page<Job> emptyPage_0_10_ASC_createdBy =
      new PageImpl<>(emptyArray, pageRequest_0_10_ASC_createdBy, 0);
  ...
  public void test_paginatedJobs_empty_DESC_status() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                get("/api/jobs/paginate?page=0&pageSize=10&sortField=status&sortDirection=DESC"))
            .andExpect(status().isOk())
            .andReturn();
  ...
  public void test_paginatedJobs_empty_ASC_createdAt() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                get("/api/jobs/paginate?page=0&pageSize=10&sortField=createdAt&sortDirection=ASC"))
            .andExpect(status().isOk())
            .andReturn();
  ...
  public void when_sortField_is_invalid_throws_exception() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                get("/api/jobs/paginate?page=0&pageSize=10&sortField=invalid&sortDirection=DESC"))
    ...
    Map<String, String> expectedResponse =
        Map.of(
            "message",
                "invalid is not a valid sort field. Valid values are [createdBy, createdAt, updatedAt, status]",
  ...
  public void when_sortDirection_is_invalid_throws_exception() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                get("/api/jobs/paginate?page=0&pageSize=10&sortField=status&sortDirection=INVALID"))
            .andExpect(status().isBadRequest())
            .andReturn();
    ...
    Map<String, String> expectedResponse =
        Map.of(
            "message", "INVALID is not a valid sort direction. Valid values are [ASC, DESC]",
            "type", "IllegalArgumentException");
