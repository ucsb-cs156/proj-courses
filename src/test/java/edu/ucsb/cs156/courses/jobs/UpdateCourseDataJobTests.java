...
public class UpdateCourseDataJobTests {
    ...
    @Test
    void test_subjectsAsString_single_subject() {
        var job = UpdateCourseDataJob.builder().build();
        var result = job.subjectsAsString(List.of("CMPSC"));
        assertEquals("[CMPSC]", result);
    }

    @Test
    void test_subjectsAsString_multiple_subjects() {
        var job = UpdateCourseDataJob.builder().build();
        var result = job.subjectsAsString(List.of("CMPSC", "ANTH", "MATH"));
        assertEquals("[CMPSC ... MATH]", result);
    }
    ...
    void test_log_output_success() throws Exception {
        ...
        String expected = 
            """
            Updating course data from [20211] to [20211] for [CMPSC]
            Updating: [CMPSC 20211]
            Done updating course data from [20211] to [20211] for [CMPSC]
            """;
    ...
    void test_log_output_with_updates() throws Exception {
        ...
        String expected = 
            """
            Updating course data from [20211] to [20211] for [MATH]
            Updating: [MATH 20211]
    ...
    void test_log_output_with_errors() throws Exception {
        ...
        String expected = 
            """
            Updating course data from [20211] to [20211] for [MATH]
            Updating: [MATH 20211] Error saving section: Testing Exception Handling!
