...
public class EnrollmentCSVServiceTests {
    ...
    void test_writeEnrollmentCSV_writesValidCSV() throws Exception {
        // Arrange
        EnrollmentDataPoint point = EnrollmentDataPoint.builder()
                .id(1L)
                .yyyyq("20252")
                .enrollCd("01234")
                .courseId("CMPSC 156")
    ...
    void test_writeEnrollmentCSV_throwsCsvDataTypeMismatchException() {
        EnrollmentCSVService badService = new EnrollmentCSVService() {
            @Override
        ...
        CsvDataTypeMismatchException ex = assertThrows(
    ...
    void test_writeEnrollmentCSV_throwsCsvRequiredFieldEmptyException() {
        ...
        CsvRequiredFieldEmptyException ex = assertThrows(
