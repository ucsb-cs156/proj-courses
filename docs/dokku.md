...
* For the value of `START_QTR` use whatever values you choose (first four digits are year, last digit is 1=Winter, 2=Spring, 3=Summer, 4=Fall), however make sure that
  `START_QTR <= endQtrYYYYQ` in UCSBAPIQuarterService.
