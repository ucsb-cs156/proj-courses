...
const columns = [
  {
    Header: "Quarter",
    accessorFn: (row) => yyyyqToQyy(row.courseInfo.quarter),
    disableGroupBy: true,
    id: "quarter",
  ...
  {
    Header: "Course ID",
    accessorFn: (row) => row.courseInfo.courseId,
    accessor: "courseId",
  ...
  {
    Header: "Title",
    accessorFn: (row) => row.courseInfo.title,
    accessor: "title",
    disableGroupBy: true,
    aggregate: getFirstVal,
    Aggregated: ({ cell: { value } }) => `${value}`,
  },
  {
    ...
    Header: "Is Section?",
    accessorFn: (row) => isSection(row.section.section),
    // Stryker disable next-line StringLiteral: this column is hidden, very hard to test
    id: "isSection",
  },
  {
  ...
  {
    Header: "Location",
    accessorFn: (row) => formatLocation(row.section.timeLocations),
    disableGroupBy: true,
    id: "location",
  ...
  {
    Header: "Days",
    accessorFn: (row) => formatDays(row.section.timeLocations),
    disableGroupBy: true,
    id: "days",
  ...
  {
    Header: "Time",
    accessorFn: (row) => formatTime(row.section.timeLocations),
    disableGroupBy: true,
    id: "time",
  ...
  {
    Header: "Instructor",
    accessorFn: (row) => formatInstructors(row.section.instructors),
    disableGroupBy: true,
    id: "instructor",
