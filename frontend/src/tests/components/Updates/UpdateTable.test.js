...
describe("UpdateTable tests", () => {
  ...
  test("renders without crashing for empty table with admin access", () => {
  ...
  test("Has expected column headers and content", async () => {
    const currentUser = currentUserFixtures.userOnly;
    ...
    ).toHaveTextContent("2023-08-24T10:58:06");
  });
});
